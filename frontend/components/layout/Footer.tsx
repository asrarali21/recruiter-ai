...
const footerLinks = {
    product: [
        ...
        { label: "For Candidates", href: "/careers" },
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-gray-400 mb-6 max-w-sm">
                            AI-powered hiring automation that helps teams find the best candidates faster, while keeping humans in control.
                        </p>
                ...
                <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="text-gray-500 text-sm">
                        © {new Date().getFullYear()} Recruiter AI. Built by Mohammed Asrar Ali.
                    </p>
